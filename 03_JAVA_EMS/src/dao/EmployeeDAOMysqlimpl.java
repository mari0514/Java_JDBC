...
public class EmployeeDAOMysqlimpl implements EmployeeDAO {
    ...
    public void addEmployee(Employee e) {
        ...
        try {
            ...
            System.out.println("Unable to add an employee");
    ...
    public Employee findEmployee(int id) throws EmployeeNotFoundException {
        ...
        try {
            ...
            employee.setDayAbsent(resultSet.getShort("department"));
    ...
    public List<Employee> findAllEmployees() throws EmployeeNotFoundException {
        ...
        try {
            ...
            System.out.println("Unable to find all the employees!");
            e.printStackTrace();
        } finally {
            try {
                preparedStatement.close();
    ...
    public void updateEmployee(Employee e) {
        ...
        try {
            ...
            System.out.println("Unable to update an employee");
            exception.printStackTrace();
        } finally {
            try {
                preparedStatement.close();
